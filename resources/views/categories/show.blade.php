                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Listado de productos de la categoria</h4>
                        </div>
                                    ...
                                    <table class="table table-striped" id="table1">
                                        ...
                                        <tbody>
                                            @forelse ($products as $product)
                                                ...
                                                <!--Danger Modal -->
                                                <div class="modal fade text-left" id="danger-{{ $product->id }}"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="myModalLabel120-{{ $product->id }}"
                                                    aria-hidden="true">
