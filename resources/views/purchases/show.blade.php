                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="date" class="form-control" name="date"
                                            value="{{ $supplier->name }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="supplier" class="form-control" name="supplier"
