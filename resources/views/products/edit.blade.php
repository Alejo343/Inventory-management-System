                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="buying_price" class="form-control"
                                                    ...
                                                    placeholder="000" aria-label="Precio compra">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="quantity" class="form-control" name="quantity"
                                                value="{{ old('quantity', $product->quantity) }}"placeholder="Cantidad">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="iva" class="form-control" name="iva"
                                                value="{{ old('iva', $product->iva) }}" placeholder="IVA">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                                ...
                                                <select class="form-select" id="iva_type" name="iva_type" required>
                                                    ...
                                                    @foreach ($ivaTypes as $ivaType)
                                                        <option value="{{ $ivaType->value }}"
                                                            {{ old('iva_type', $product->iva_type->value ?? '') == $ivaType->value ? 'selected' : '' }}>
                                                            {{ $ivaType->label() }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="notes" class="form-control" name="notes"
                                                value="{{ old('notes', $product->notes) }}" placeholder="Notas">
                                        </div>
                                    </div>
