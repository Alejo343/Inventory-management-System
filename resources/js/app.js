        ...
        (function (s, f) {
            ...
            class tt extends he {
                ...
                _addTouchEventListeners() {
                    ...
                    const t = {
                        leftCallback: () =>
                            this._slide(this._directionToOrder(et)),
                        rightCallback: () =>
                    ...
                    if (
                        (this._config.parent &&
                            (e = this._getFirstLevelChildren(Vo)
                                ...
                                .map((y) =>
                                    it.getOrCreateInstance(y, { toggle: !1 })
                                )),
            ...
            function lt(n, e, t) {
                ...
                e &&
                    ce(n) &&
                    ((o =
                        (n.offsetWidth > 0 && at(i.width) / n.offsetWidth) ||
                        1),
                    (c =
                        (n.offsetHeight > 0 && at(i.height) / n.offsetHeight) ||
                        1));
            ...
            function jt(n, e) {
                ...
                var i = Ei(n),
                    ...
                    c = se(i),
                    d = o
                        ? [c].concat(c.visualViewport || [], An(i) ? i : [])
                        : i,
                    y = e.concat(d);
                    ...
                    var j = {
                        ...
                        N = {
                            ...
                            setOptions: function (Y) {
                                ...
                                var Q = _s(
                                    bs([].concat(i, j.options.modifiers))
                                );
                                return (
                                    (j.orderedModifiers = Q.filter(function (
                                        V
                                    ) {
                                        return V.enabled;
                                    })),
            ...
            class Ki extends gt {
                ...
                _handleKeydown(e) {
                    e.key === sa &&
                        (this._lastTabNavDirection = e.shiftKey ? Fi : aa);
                }
            }
            ...
            class we extends he {
                ...
                hide() {
                    if (
                        !this._isShown ||
                        x.trigger(this._element, Ia).defaultPrevented
                    )
                        return;
                    this._focustrap.deactivate(),
                        this._element.blur(),
            ...
            class Ot extends he {
                ...
                hide() {
                    if (
                        !this.isShown() ||
                        x.trigger(this._element, ql).defaultPrevented
                    )
                        return;
                    const t = () => {
